...
const CONFIG = {
  ...
  story: {
    title: "우리의 이야기",
    content: "가까운 사람이 생긴다는 건 그런 것 같습니다.\n둘만 있을 때 요상한 춤을 함께 추고, 서로의 웃긴 말투를 따라 하며 며칠이고 함께 웃는 것.\n\n나이를 먹어도 영영 자라지 않는 마음이 있다는 게 어쩌면 행운 같습니다.\n무엇보다도, 자라지 않는 마음을 편안히 내보일 수 있는 사람이 곁에 있다는 것이 가장 행운이겠지요.\n\n이제는 그 행운을 서로의 곁에서 평생 지켜나가고자 합니다.\n저희가 가족이 되어 나아가는 뜻깊은 날, 따뜻한 마음으로 함께해 주시면 좋겠습니다."
  },
