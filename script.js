  ...
  function initPhotoModal() {
    ...
    container.addEventListener('touchend', (e) => {
      ...
      if (!isPinching) {
        ...
        if (currentScale <= 1.05) handleSwipe();
      }
    }, { passive: true });
    ...
    $('#modalPrev').addEventListener('dblclick', (e) => { e.preventDefault(); }, { passive: false });
    $('#modalNext').addEventListener('dblclick', (e) => { e.preventDefault(); }, { passive: false });
    $('#modalClose').addEventListener('dblclick', (e) => { e.preventDefault(); }, { passive: false });
  }
